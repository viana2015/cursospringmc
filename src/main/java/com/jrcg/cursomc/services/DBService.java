...
import com.jrcg.cursomc.domain.PagamentoComCartao;
...
import com.jrcg.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase( ) throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "cristiano.gvianati@gmail.com", "08583582718", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "robertadandrea@gmail.com", "08583582718", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avinida Matos", "105", "sala 303", "Centro", "38220834", cli1, c2);
		Endereco e3 = new Endereco(null, "Avinida Paulista", "205", null, "Centro", "38220834", cli2, c2);
